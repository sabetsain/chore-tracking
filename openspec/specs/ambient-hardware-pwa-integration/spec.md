# ambient-hardware-pwa-integration Specification

## Purpose
Specifies device and browser hardware integrations including Screen Wake Lock for countertop displays, Web App Badging for pending counts, Web Share API, and actionable push notifications.
