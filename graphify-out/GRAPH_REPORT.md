...
## Corpus Check
- 216 files · ~131,775 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 12 file(s) not represented in the graph (top: (none) 7, .example 1, .ini 1)

## Summary
- 1463 nodes · 2898 edges · 121 communities (98 shown, 12 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 283 edges (avg confidence: 0.94)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `68f68e5f`
...
- architectural-deepening/proposal.md
- Technical Design: Warm Minimalist UI Revamp
- test_full_roommate_lifecycle_simulation
- Decisions
- Backend Python Dependencies
- architectural-deepening/tasks.md
- 2026-09-12-custom-appliance-engine/proposal.md
...
- 2026-09-12-hybrid-development-setup/proposal.md
- 2026-09-12-warm-minimalist-ui-revamp/proposal.md
- Requirement: Unified Household Onboarding and Authentication Service
- 2026-09-12-custom-appliance-engine/tasks.md
- Implementation Tasks: Warm Minimalist UI Revamp
- 2026-09-12-hybrid-development-setup/tasks.md
- vite.config.ts
- Docker Compose Profiles

## God Nodes (most connected - your core abstractions)
1. `Member` - 78 edges
2. `ChoreAssignment` - 37 edges
3. `Household` - 33 edges
4. `Chore` - 32 edges
5. `react` - 30 edges
6. `vitest` - 25 edges
7. `Appliance` - 23 edges
8. `PushSubscription` - 22 edges
9. `@testing-library/react` - 21 edges
10. `Member` - 19 edges
...
### Community 0 - "Member"
Cohesion: 0.10
Nodes (79): Chore, ChoreAssignment, ChoreLog, Household, Member, activate_rotation(), ChoreRoute, claim_chore_assignment() (+71 more)

### Community 1 - "appliances.py"
Cohesion: 0.10
Nodes (48): Appliance, ApplianceStateLog, Appliance, ApplianceStateLog, ApplianceRoute, create_appliance(), get_appliance(), get_appliance_history() (+40 more)

### Community 2 - "MVP System Architecture & Design"
Cohesion: 0.05
...
Cohesion: 0.16
Nodes (26): AddApplianceModal(), AddApplianceModalProps, CANONICAL_STATES, ICON_OPTIONS, PRESET_TEMPLATES, ApplianceCard(), ApplianceCardProps, computeNextState() (+18 more)

### Community 4 - "/opsx-archive Command"
Cohesion: 0.07
...
### Community 5 - "react"
Cohesion: 0.10
Nodes (24): ChoreLogModal(), ChoreLogModalProps, ChoreSwapModal(), ChoreSwapModalProps, CreateChoreModal(), CreateChoreModalProps, COVER_STYLES, CoverStyle (+16 more)

### Community 6 - "ChoreCard.tsx"
Cohesion: 0.08
Nodes (26): ChoreCardVariant, getDeterministicTilt(), getDeterministicVariant(), IdentitySticker(), IdentityStickerProps, IdentityStickerVariant, VARIANT_CLASSES, VARIANTS (+18 more)

### Community 7 - "App.tsx"
Cohesion: 0.11
Nodes (30): App(), MainApp(), queryClient, RootView(), ChoreCard(), ChoreCardProps, ChoreDutyView(), ChoreDutyViewProps (+22 more)

### Community 8 - "test_websockets.py"
Cohesion: 0.31
Nodes (12): MockWebSocket, AsyncClient, asyncio, test_ws_broadcast_appliance_state_changed(), test_ws_broadcast_chore_events(), test_ws_broadcast_member_status_changed(), test_ws_broadcast_sensor_event(), test_ws_connection_accepted_for_valid_household() (+4 more)
...
### Community 10 - "vitest"
Cohesion: 0.18
Nodes (10): Header(), HeaderProps, SettingsViewProps, AuthContextType, Household, Member, soundEffects, @testing-library/react (+2 more)
...
### Community 12 - "Household Coordination App — Future Features & Product Roadmap"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (25): Purpose, Requirement: 4-State Ergonomic Button System, Requirement: 60-30-10 Warm Anti-Glare Color Palette, Requirement: IdentitySticker Primitive for Roommates and Chores, Requirement: Intentional Negative Space and Seamless Unified Canvas, Requirement: Micro-Haptic Signatures, Requirement: StatusStamp Primitive for System State Output, Requirement: Zero-Dependency Web Audio Synthesizer (+17 more)

### Community 14 - "Household Coordination App — Design System Specification"
Cohesion: 0.09
...
Cohesion: 0.16
Nodes (20): ApplianceCreate, ApplianceStateLogOut, ApplianceStateUpdate, ApplianceUpdate, ChoreCreate, ChoreLogCreate, ChoreLogOut, ChoreReassignRequest (+12 more)

### Community 20 - "Requirements"
Cohesion: 0.10
Nodes (20): developer-environment Specification, Purpose, Requirement: Containerized Database Isolation and Service Profiles, Requirement: Database Readiness Verification, Requirement: Graceful Local Process Lifecycle and Signal Trapping, Requirement: Modular Developer Orchestration Runner, Requirement: Standalone Database Migration Pipeline, Requirements (+12 more)

### Community 21 - "dev.sh"
Cohesion: 0.23
Nodes (11): cleanup(), resolve_frontend(), resolve_uvicorn(), run_migrations(), dev.sh script, start_backend(), start_db(), start_frontend() (+3 more)
...
### Community 23 - "Requirement: Hybrid Completion Tracking"
Cohesion: 0.12
...
### Community 24 - "push.py"
Cohesion: 0.19
Nodes (12): get_vapid_public_key(), AsyncSession, delete, get, post, subscribe(), unsubscribe(), PushSubscriptionDelete (+4 more)

### Community 25 - "test_chores_crud.py"
Cohesion: 0.34
...
### Community 26 - "test_chore_rotation.py"
Cohesion: 0.36
...
### Community 27 - "test_member_admin.py"
Cohesion: 0.35
...
### Community 29 - "Requirement: Inertial Touch Gesture Page Turns"
Cohesion: 0.14
...
### Community 30 - "test_appliances_crud.py"
Cohesion: 0.36
...
### Community 35 - "NEW Requirements"
Cohesion: 0.11
Nodes (18): NEW Requirements, Requirement: Containerized Database Isolation and Service Profiles, Requirement: Database Readiness Verification, Requirement: Graceful Local Process Lifecycle and Signal Trapping, Requirement: Modular Developer Orchestration Runner, Requirement: Standalone Database Migration Pipeline, Scenario: Detecting missing Python dependencies, Scenario: Gating on database readiness during container boot (+10 more)
...
### Community 37 - "household_service.py"
Cohesion: 0.17
Nodes (29): AuthResponse, AuthRoute, login(), APIRoute, AsyncSession, post, MemberRoute, APIRoute (+21 more)

### Community 38 - "households.py"
Cohesion: 0.22
Nodes (9): create_household(), HouseholdRoute, join_household(), APIRoute, AsyncSession, patch, post, regenerate_invite_code() (+1 more)

### Community 39 - "test_auth.py"
Cohesion: 0.44
...
### Community 41 - "test_chore_completion.py"
Cohesion: 0.47
...
### Community 42 - "test_households.py"
Cohesion: 0.47
...
### Community 43 - "pushNotifications.ts"
Cohesion: 0.60
...
### Community 44 - "2026-08-26-paper-notebook-design-system/design.md"
Cohesion: 0.20
...
### Community 45 - "Requirement: Core Appliance State Machine"
Cohesion: 0.20
...
### Community 46 - "2026-08-27-tactile-ui-revamp/design.md"
Cohesion: 0.20
...
### Community 49 - "Requirement: Core Appliance State Machine"
Cohesion: 0.11
...
### Community 50 - "Skill: openspec-new-change"
Cohesion: 0.22
...
### Community 51 - "test_chore_swap.py"
Cohesion: 0.44
...
### Community 53 - "2026-08-26-paper-notebook-design-system/tasks.md"
Cohesion: 0.22
...
### Community 56 - "test_chore_up_for_grabs.py"
Cohesion: 0.46
...
### Community 58 - "2026-08-27-tactile-ui-revamp/tasks.md"
Cohesion: 0.25
...
### Community 59 - "Skill: openspec-apply-change"
Cohesion: 0.33
...
Cohesion: 0.24
Nodes (11): api, ApiError, getStoredToken(), request(), setStoredToken(), AuthContext, AuthProvider(), defaultAuthContext (+3 more)

### Community 62 - "websocket.py"
Cohesion: 0.23
Nodes (8): health_check(), get, decode_access_token(), ConnectionManager, Any, UUID, websocket_endpoint(), WebSocket

### Community 63 - "2026-08-26-paper-notebook-design-system/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 64 - "2026-08-27-refine-appliances-and-chores/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 65 - "2026-08-27-tactile-ui-revamp/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 66 - "2026-08-28-chore-bucket-rotation-and-uncheck/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 67 - "Decisions"
Cohesion: 0.15
Nodes (12): Context, Decision 1: Deep Backend Domain Services with Explicit Domain Exceptions, Decision 2: Encapsulation of Transaction Commits and Real-Time Sync, Decision 3: Removal of Speculative IoT Smart Plug Power Ingestion, Decision 4: Delegated Seeding via Appliance Service, Decision 5: Frontend Domain-Split Hooks with Optional Domain Prop Injection, Decision 6: Unified `ChoreCard.tsx` Aligned with Warm Minimalist Functionalism, Decisions (+4 more)
...
### Community 69 - "Skill: openspec-bulk-archive-change"
Cohesion: 0.40
...
### Community 70 - "Skill: openspec-explore"
Cohesion: 0.33
...
### Community 71 - "Skill: openspec-onboard"
Cohesion: 0.33
...
### Community 72 - "Skill: openspec-verify-change"
Cohesion: 0.33
...
### Community 73 - "test_chore_unclaim_and_management.py"
Cohesion: 0.44
...
### Community 74 - "Requirement: Core Appliance State Machine"
Cohesion: 0.18
Nodes (10): MODIFIED Requirements, REMOVED Requirements, Requirement: Core Appliance State Machine, Requirement: Seeding Default Appliances, Requirement: Sensor-Ready Event Webhook, Scenario: Advancing appliance state through domain service, Scenario: Appliance not found in household, Scenario: Enforcing domain exceptions on invalid transition (+2 more)

### Community 75 - "Skill: openspec-archive-change"
Cohesion: 0.50
...
### Community 76 - "Skill: openspec-continue-change"
Cohesion: 0.50
...
### Community 77 - "Skill: openspec-sync-specs"
Cohesion: 0.40
...
### Community 79 - "Requirement: Unified Chore Card Component"
Cohesion: 0.18
Nodes (10): ADDED Requirements, MODIFIED Requirements, Requirement: Unified Chore Card Component, Requirement: Unified Chore Domain Service, Scenario: Chore or duty not found, Scenario: Enforcing domain exceptions on invalid chore operations, Scenario: Operating on chore duties through domain service, Scenario: Rendering interactive personal duty card (+2 more)

### Community 80 - "Q: Why does Member connect Core Database Models & Chore Service to Backend API Routers & Alembic Environment, Household Creation & Join Tests, Member Admin & Permissions Tests, and Web Push Subscriptions & Notification Service?"
Cohesion: 0.40
...
### Community 81 - "Requirement: Chore Definition and Configuration"
Cohesion: 0.40
...
### Community 82 - "2026-08-27-refine-appliances-and-chores/tasks.md"
Cohesion: 0.40
...
### Community 94 - "architectural-deepening/proposal.md"
Cohesion: 0.20
Nodes (9): 1. Deep Backend Domain Services (Candidates 1, 2, 3), 2. Frontend Domain Hooks & Orchestration Thinning (Candidate 4), 3. Unified Chore Card Presentation Module (Candidate 5), Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes (+1 more)

### Community 95 - "Technical Design: Warm Minimalist UI Revamp"
Cohesion: 0.20
...
### Community 96 - "test_full_roommate_lifecycle_simulation"
Cohesion: 0.22
...
Cohesion: 0.22
Nodes (8): Context, Decision 1: Compose Service Profiles (`profiles: ["full"]`), Decision 2: Standalone Shell Migration Runner (`scripts/migrate.sh`), Decision 3: Socket & `pg_isready` Readiness Gate (`scripts/wait-for-db.sh`), Decision 4: Signal Trapping & Process Group Management in `scripts/dev.sh`, Decision 5: Separation of Concerns & Alembic DAG Freeze, Decisions, Goals / Non-Goals

### Community 100 - "architectural-deepening/tasks.md"
Cohesion: 0.29
Nodes (6): 1. Backend Chore Domain Consolidation (Candidate 1), 2. Encapsulated Appliance State Machine & Removal of Sensor Events (Candidate 2), 3. Household Onboarding & Auth Service (Candidate 3), 4. Frontend Domain Hooks & Orchestrator Thinning (Candidate 4), 5. Unified ChoreCard Component & Warm Minimalist Presentation (Candidate 5), 6. Full Verification & Knowledge Graph Update

### Community 101 - "2026-09-12-custom-appliance-engine/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 110 - "2026-09-12-hybrid-development-setup/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 111 - "2026-09-12-warm-minimalist-ui-revamp/proposal.md"
Cohesion: 0.29
Nodes (6): Capabilities, Impact, Modified Capabilities, New Capabilities, What Changes, Why

### Community 112 - "Requirement: Unified Household Onboarding and Authentication Service"
Cohesion: 0.33
Nodes (5): MODIFIED Requirements, Requirement: Unified Household Onboarding and Authentication Service, Scenario: Creating a new household and onboarding the founding member, Scenario: Enforcing domain exceptions on invalid credentials or conflicts, Scenario: Joining an existing household with unique nickname validation

### Community 113 - "2026-09-12-custom-appliance-engine/tasks.md"
Cohesion: 0.33
...
### Community 114 - "Implementation Tasks: Warm Minimalist UI Revamp"
Cohesion: 0.33
...
### Community 115 - "2026-09-12-hybrid-development-setup/tasks.md"
Cohesion: 0.40
Nodes (4): 1. Docker Compose & Database Readiness, 2. Standalone Alembic Migration Runner, 3. Modular Local Development Runner & Signal Handling, 4. End-to-End Verification & Knowledge Graph Sync
...
- **Why does `Member` connect `Member` to `members.py`, `appliances.py`, `test_full_roommate_lifecycle_simulation`, `household_service.py`, `households.py`, `PushSubscription`, `test_households.py`, `models.py`, `push.py`, `test_member_admin.py`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ChoreAssignment` connect `Member` to `test_full_roommate_lifecycle_simulation`, `test_chore_unclaim_and_management.py`, `test_chore_completion.py`, `models.py`, `test_chore_swap.py`, `test_chore_up_for_grabs.py`, `test_chore_rotation.py`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `react` connect `react` to `types/index.ts`, `ChoreCard.tsx`, `App.tsx`, `vitest`, `pushNotifications.ts`, `package.json`, `client.ts`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Are the 60 inferred relationships involving `Member` (e.g. with `create_appliance()` and `get_appliance()`) actually correct?**
  _`Member` has 60 INFERRED edges - model-reasoned connections that need verification._
- **Are the 24 inferred relationships involving `ChoreAssignment` (e.g. with `claim_chore()` and `complete_chore()`) actually correct?**
  _`ChoreAssignment` has 24 INFERRED edges - model-reasoned connections that need verification._
- **Are the 22 inferred relationships involving `Household` (e.g. with `activate_chore_rotation()` and `deactivate_chore_rotation()`) actually correct?**
  _`Household` has 22 INFERRED edges - model-reasoned connections that need verification._
- **Are the 25 inferred relationships involving `Chore` (e.g. with `activate_chore_rotation()` and `claim_chore()`) actually correct?**
  _`Chore` has 25 INFERRED edges - model-reasoned connections that need verification._