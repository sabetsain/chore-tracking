...
## Summary
- 853 nodes · 1593 edges · 81 communities (66 shown, 15 thin omitted)
...
### Community 0 - "Member"
Cohesion: 0.06
Nodes (92): get_db(), AsyncSession, Chore, Member, login(), AsyncSession, post, claim_chore_assignment() (+84 more)

### Community 1 - "App.tsx"
Cohesion: 0.05
Nodes (61): api, ApiError, getStoredToken(), request(), setStoredToken(), App(), MainApp(), queryClient (+53 more)

### Community 2 - "models.py"
Cohesion: 0.08
Nodes (49): do_run_migrations(), Run migrations in 'offline' mode., Run migrations in 'online' mode using async engine., Run migrations in 'online' mode using sync engine., Run migrations in 'online' mode., run_async_migrations(), run_migrations_offline(), run_migrations_online() (+41 more)

### Community 3 - "test_push_notifications.py"
Cohesion: 0.12
...
### Community 4 - "stationery/index.ts"
Cohesion: 0.06
Nodes (27): NotebookTab(), NotebookTabProps, PaperCard, PaperCardProps, PaperCardTilt, PaperCardVariant, PaperclipFastener(), PaperclipFastenerProps (+19 more)
...
### Community 24 - "9. Implementation Roadmap & Component Migration Guide"
Cohesion: 0.22
...
### Community 27 - "Household Core Specification"
Cohesion: 0.22
...
### Community 28 - "Chore Management Specification"
Cohesion: 0.22
...
### Community 32 - "Appliance Tracking Specification"
Cohesion: 0.25
...
### Community 34 - "MVP System Architecture & Design"
Cohesion: 0.29
...
### Community 36 - "Skill: openspec-bulk-archive-change"
Cohesion: 0.40
...
### Community 37 - "Skill: openspec-explore"
Cohesion: 0.33
...
### Community 38 - "Skill: openspec-onboard"
Cohesion: 0.33
...
### Community 39 - "Skill: openspec-verify-change"
Cohesion: 0.33
...
### Community 40 - "FastAPI Backend Service"
Cohesion: 0.47
...
### Community 41 - "test_migrations.py"
Cohesion: 0.33
Nodes (4): alembic_config(), asyncio, fixture, test_async_migration_upgrade_and_downgrade()

### Community 42 - "Household Coordination App — Paper Notebook Design System"
Cohesion: 0.33
...
### Community 43 - "Household Coordination App Documentation"
Cohesion: 0.33
...
### Community 44 - "Skill: openspec-archive-change"
Cohesion: 0.50
...
### Community 45 - "Skill: openspec-continue-change"
Cohesion: 0.50
...
### Community 46 - "Skill: openspec-sync-specs"
Cohesion: 0.40
...
### Community 47 - "7.1 Breakpoint Specifications"
Cohesion: 0.40
...
### Community 48 - "2. Color Tokens & Surface Hierarchy"
Cohesion: 0.40
...
### Community 49 - "3. Typography System & Font Pairing"
Cohesion: 0.40
...
### Community 52 - "Notification System Specification"
Cohesion: 0.40
...
### Community 57 - "4. Motion, Physics & Page-Flip Engine"
Cohesion: 0.50
...
### Community 58 - "8. Accessibility (a11y) & Standards Compliance"
Cohesion: 0.50
...
## Knowledge Gaps
- **248 isolated node(s):** `ApplianceCardProps`, `NextStateConfig`, `StatusBadgeConfig`, `ApplianceDashboardProps`, `ChoreDutyViewProps` (+243 more)
...
- **Why does `Member` connect `Member` to `test_households.py`, `models.py`, `test_member_admin.py`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `ChoreAssignment` connect `models.py` to `Member`, `test_chore_up_for_grabs.py`, `test_chore_rotation.py`, `test_chore_swap.py`?**
