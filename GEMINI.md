...
When starting a session on this repository, please read the project handoff document located at `~/.gemini/handoffs/household-coordination-handoff.md` to understand the current architecture, completed MVP capabilities, conventions, and upcoming roadmap.
